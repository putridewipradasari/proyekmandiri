...
class Ion_auth
{
	...
	public function is_admin($id = FALSE)
	{
		...
		//$osis_group = $this->config->item('osis_group', 'ion_auth');

		//return $this->in_group($osis_group, $id);
	}

	public function is_osis($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_osis');

                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
					 ...
					 <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
						...
						<div class="row clearfix">
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
									<?php echo form_label('Organisasi Saat SMA'); ?>
								</div>
								<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
									<div class="form-group">
										<div class="form-line">
										<?php echo form_error('ekskul');$row_ekskul = array();
                                            foreach ($_ref_ekskul as $ref) {
                                                $row_ekskul[$ref->nm_ekskul] = $ref->nm_ekskul;
                                            }
                                            echo form_dropdown($ekskul, $row_ekskul, $ekskul['value']);
                                        ?>
										</div>
									</div>
								</div>
							...
							<div class="row clearfix">
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
									<?php echo form_label('Tanggal Acara'); ?>
								</div>
								<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
									<div class="form-group">
										<div class="form-line">
										<?php echo form_error('tanggal_acara');
                                            echo form_input($tanggal_acara);
                                        ?>
										</div>
									</div>
								</div>
						...
						<div class="row clearfix">
							<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
									<?php echo form_label('Lampirkan File'); ?>
								</div>
								<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
								<div class="form-group">
										<div class="form-line">
										<?php echo form_error('berkas');
                                            echo form_upload($berkas);
                                        ?>
								</div>
							</div>
						</div>
					    ...
					    <?php 
								...
								<div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <?php echo form_submit('submit', 'kirim', array('class' => 'btn btn-flat btn-primary'));

                                    ...
                                    <tbody>                                       
                                        ...
                                        foreach ($_get_event as $row):?>
											<tr>
                                                ...
                                                <td><?php echo htmlspecialchars(indonesian_date($row->tanggal_acara), ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td>	
												<?php echo anchor('event/read/'.encrypt_url($row->id), '<button type="button" class="btn btn-primary btn-circle waves-effect waves-circle waves-float">
												...
												<?php echo anchor('event/delete/'.$row->id, '<button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" onclick="return confirmDialog()">

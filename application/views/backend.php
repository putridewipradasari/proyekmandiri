...
<?php if ($this->ion_auth->in_group('osis')) {
    ?>
...
<?php
        ...
        ?>
                    ...
                    <li <?php echo /*$segment1 == 'referensi_tahun' ||*/ $segment1 == 'referensi_ekskul' ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">search</i>
                            <span>Organisasi SMA</span>
                        </a>
                        <ul class="ml-menu">
                            <!--<li <?php // echo $segment1 == 'referensi_tahun' ? 'class="active"' : ''; ?>
                                <?php //echo anchor('referensi_tahun', 'Ref Tahun'); ?>
                            </li> 	-->					
                            <li <?php echo $segment1 == 'referensi_ekskul' ? 'class="active"' : ''; ?>>
                                <?php echo anchor('referensi_ekskul', 'Organisasi SMA'); ?>
                            </li> 						
						</ul>
                    </li>
                    <li <?php echo $segment2 == 'change_password' ? 'class="active"' : ''; ?>>
        ...
        ?>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; <?php echo date('Y'); ?> <a href="javascript:void(0);">Kelompok 2</a>.
                </div>
                <div class="version">
                    <b>Version: </b> pum
                </div>

		    	...
		    	<div class="nav-wrapper teal">
		    		<div class="container">
			      		<ul id="nav-mobile" class="hide-on-med-and-down">
					        <li><?php echo anchor('', '<i class="material-icons">school</i>'); ?></li>                       
...
<div class="bg"></div>
		<div class="title">
			...
			<a href="<?php echo site_url('login'); ?>" class="waves-effect waves-light btn-large teal accent-4" data-aos="fade-left">Login</a>		
        </div>

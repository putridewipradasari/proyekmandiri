                    ...
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Tanggal Acara</td>
                                    <td><?php echo indonesian_date($tanggal_acara); ?></td>
                                </tr>
                                <tr>
                                    <td>Lampiran File</td>
                                    <td><?php //echo $berkas;?>
                                    <iframe src= "<?php echo base_url('upload'); ?>/<?php echo $berkas;?>" width='100%' height='700px'></iframe>
                                </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><?php if (/*$this->ion_auth->is_admin()*/$this->ion_auth->is_osis()) {
    ?>

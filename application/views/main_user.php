                                    ...
                                    <tbody>                                        
										<?php foreach ($users as $user):?>
											<tr>
												...
												<td><?php echo ($user->active) ? anchor('user/deactivate/'.encrypt_url($user->id), lang('index_active_link')) : anchor('user/activate/'.encrypt_url($user->id), lang('index_inactive_link')); ?></td>
												<td>
												<?php foreach ($user->groups as $group):?>
												
												<?php endforeach; ?>
												<?php echo anchor('user/edit_user/'.encrypt_url($user->id), '<button type="button" class="btn btn-warning btn-circle waves-effect waves-circle waves-float">

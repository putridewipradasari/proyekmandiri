...
class Profil extends CI_Controller
{
    ...
    public function profil_user()
    {
        ...
        if ($num_rows == 1) {
            ...
            redirect('profil/profil_ubah_data/'.encrypt_url($id_profil).'', 'refresh');
        } else {
    ...
    public function status_alumni()
    {
        ...
        if ($num_rows == 1) {
            ...
            redirect('profil/status_alumni_ubah_data/'.encrypt_url($id_status).'', 'refresh');
        } else {
    ...
    public function profil_tambah_data()
    {
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->data['_ref_ekskul'] = $this->profil->get_ref_ekskul();
    ...
    public function profil_ubah_data($id_user)
    {
        if (!$this->ion_auth->logged_in()) {
            // redirect them to the login page
            ...
            $this->data['is_user'] = $this->ion_auth->user()->row();
            $id_user = $this->ion_auth->user()->row()->id;
            $row = $this->profil->get_by_id($id_user);
    ...
    public function profil_ubah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->profil->update($this->input->post('id_user', true), $data);
    ...
    public function status_alumni_tambah_data()
    {
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->data['_view'] = 'status_alumni_form';
            $this->template->_render_page('backend', $this->data);
        }
    }
    ...
    public function status_alumni_ubah_data($id_user)
    {
        if (!$this->ion_auth->logged_in()) {
            // redirect them to the login page
            redirect('auth/login', 'refresh');
            ...
            $this->data['is_user'] = $this->ion_auth->user()->row();
            $id_user = $this->ion_auth->user()->row()->id;
            $row = $this->status->get_by_id($id_user);
    ...
    public function status_alumni_ubah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->status_alumni_ubah_data($this->input->post('id_user', true));
        } else {
            $data = array(
            'id_user' => $this->input->post('id_user', true),
            'status' => $this->input->post('status', true),
            ...
            $this->status->update($this->input->post('id_user', true), $data);
    ...
    public function _profil_rules()
    {
        ...
        $this->form_validation->set_rules('ekskul', 'ekstrakulikuler', 'trim|required');

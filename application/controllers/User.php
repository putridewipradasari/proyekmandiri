...
class User extends CI_Controller
{
    ...
    public function deactivate($id = null)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $this->data['_view'] = 'deactivate_user';
            $this->template->_render_page('backend', $this->data);
        } else {
